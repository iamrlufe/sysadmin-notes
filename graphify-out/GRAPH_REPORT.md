...
7. `Реиндексация и обновление статистики MS SQL Server (1С)` - 10 edges
8. `Сопоставление групп Diffie-Hellman в MikroTik и Juniper SSG` - 10 edges
9. `Настройка DCOM для Microsoft Excel Application (1С)` - 10 edges
10. `Диагностика и управление агентами очереди Asterisk` - 9 edges
